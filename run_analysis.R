...
# Merge the training subjects and test into data tables to make single data table
humanActivity <- rbind(
...
# Assignment Task 2 - Extract only the measurements on the mean and standard deviation
...
# Assignemtn Task 3 - Use descriptive activity names to name the activities in the data
#          set
...
# Assignemnt Task 5 - Create a second, independent tidy set with the average of each
